...
export const defaultUserProfile: UserProfile = {
  name: "Jordan Rivera",
  headline: "Software engineer open to full-time and contract roles.",
  summary: "Update this section with your own background, experience, and what you're looking for.",
  preferredLocations: ["Austin, TX", "Chicago, IL"],
  preferredStates: ["TX", "IL"],
  remotePreference: ["REMOTE", "HYBRID"],
  targetCategories: ["SOFTWARE"],
  targetTitles: ["software engineer", "backend engineer", "full stack developer"],
  skills: ["Python", "Java", "SQL", "Docker"],
  stacks: ["Django", "PostgreSQL", "AWS"],
  industries: ["FinTech", "SaaS"],
  contactRoleTargets: ["Recruiter", "Hiring Manager"],
  educationEntries: [],
  companiesWorked: [],
  schoolKeywords: [],
  connectionKeywords: [],
