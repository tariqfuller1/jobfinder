...
export const defaultUserProfile: UserProfile = {
  name: "Your Name",
  headline: "Software engineer and game developer candidate building polished, user-focused work.",
  summary:
    "Use your account profile to save your resume, preferred locations, target roles, and skills so the job board, resume rewrite, and cover letter tools can tailor suggestions to you.",
  preferredLocations: ["Remote US"],
  preferredStates: [],
  remotePreference: ["REMOTE", "HYBRID", "ONSITE"],
  targetCategories: ["BOTH", "SOFTWARE", "GAMING"],
  targetTitles: ["software engineer", "software developer", "gameplay programmer", "frontend engineer", "full stack engineer"],
  skills: ["JavaScript", "TypeScript", "React", "C#", "C++", "Problem solving"],
  stacks: ["React", "Next.js", "TypeScript"],
  industries: ["Software", "Games"],
  contactRoleTargets: ["Recruiter", "Engineering Manager", "Hiring Manager"],
  educationEntries: [],
  companiesWorked: [],
  schoolKeywords: [],
  connectionKeywords: [],
